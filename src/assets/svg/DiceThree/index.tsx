...
const DiceThree: React.FC<DiceProps> = ({ w, h }) => {
  return (
    <svg
      width={w}
      height={h}
      ...
      <path
        style={{ fill: '#FFFFFF' }}
        d="M55.552,508C27.12,508,4,484.872,4,456.448V55.552C4,27.128,27.128,4,55.552,4H456.44
	...
	C0,487.128,24.872,512,55.552,512H456.44c30.688,0,55.56-24.872,55.56-55.552V55.552C512,24.872,487.128,0,456.448,0L456.448,0z"
      />
      <g>
        <circle style={{ fill: '#FF7888' }} cx="394.72" cy="256" r="45.256" />
        <circle style={{ fill: '#FF7888' }} cx="256" cy="256" r="45.256" />
        <circle style={{ fill: '#FF7888' }} cx="117.256" cy="256" r="45.256" />
      </g>
      <g></g>
      <g></g>
      <g></g>
